...
/* У словный пример использования вложенного класса
В класс А вложен класс В метод print обьявлен и 
определен в классе, а метод setB определен вне класса 
Для этого используется описание полного пути к калассу 
*/
class A {
    int a{};
...
/*
Пример использлвания вложенных классов на примере класса Image и 
вложенного класса Pixel
...
/*
Условный пример наследования, гда класс F - родительский, а
класс G1 - наследует функциональность класса F
...
/*Пример иллюстрирующий работы модификаторов доступа и модификаторов 
наследования
*/
